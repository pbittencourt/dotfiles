...
notify-send -u low -t 1800 "MINIDLNA" "Iniciando daemon ..."
echo "┌──────────────────────────────────────┐"
echo "│ MINIDLNA LAUNCHER                    │"
echo "└──────────────────────────────────────┘"
echo ""
...
# o HD externo deve estar montado
...
if output=$(sudo service minidlna restart; sudo service minidlna force-reload); then
    printf '%s' "$output"
