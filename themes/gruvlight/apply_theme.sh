...
notify-send -u normal -t 900 "Theme changing" "Aplicando tema GRUVLIGHT.."
...
# kitty
sed -i -e "s/^include.*/include \.\/themes\/gruvbox_light.conf/g" ~/dotfiles/kitty/kitty.conf

# vim
cat ~/.vimrc-base "$dir_path/vim" > ~/.vimrc

# rofi
sed -i -e "s/theme.*/theme: \".\/themes\/gruvbox-light.rasi\";/g" ~/.config/rofi/config.rasi
...
notify-send -u low -t 1800 "Theme changing" "Tema GRUVLIGHT aplicado com sucesso!"
